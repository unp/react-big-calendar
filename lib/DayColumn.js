...
var DaySlot = _react2.default.createClass({
  ...
  _handleDeleteKey: function _handleDeleteKey(event) {
    if (event.code === 'Backspace' && this.props.selected && event.target.tagName.toLowerCase() !== 'input' && event.target.tagName.toLowerCase() !== 'textarea') {
  ...
  renderEvents: function renderEvents() {
    ...
    return events.map(function (event, idx) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(EventEdit, { onDelete: onDelete, event: event })
      );
    });
  },
